// src/components/home/PassesClient.tsx
'use client';
...
import { PassWithFeatures } from './PassesSection'; // Import the type from the parent server component

type PassesClientProps = {
  passes: PassWithFeatures[];
};

const PassesClient = ({ passes }: PassesClientProps) => {
  ...
  if (!passes || passes.length === 0) {
    return <p className="text-center text-gray-500">No passes are currently available.</p>;
  }
